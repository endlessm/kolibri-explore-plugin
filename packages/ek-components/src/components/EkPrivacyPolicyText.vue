<template>
  <div>
    ...
    <p>
      ...
      device, or via USB disk (the “<b>Service</b>”). Endless Key is
    ...
    <p>
      This Endless Key Privacy Policy (this “<b>Policy</b>”) describes
